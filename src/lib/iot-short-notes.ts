...
![Module 1 Overview](/iot-m1-overview.png)
...
![HC-SR501 PIR Module](/iot-pir2.png)
Fresnel Lens:
...
![ESP8266/ESP32 Wi-Fi](/iot-esp32.png)
...
![Multi-Sensor Security System](/iot-multi-sensor.png)
Alarm States:
...
![Alarm States](/iot-alarm-states.png)
...
![IoT Protocols](/iot-protocols.png)
Protocol Comparison:
...
![MQTT Architecture](/iot-mqtt-arch.png)
Topics:
...
![ArduinoJson](/iot-arduinojson.png)
HTTPClient Usage:
HTTPClient http;
http.begin(url);
...
![ESP-NOW Protocol](/iot-esp-now.png)
Setup:
WiFi.mode(WIFI_STA);
esp_now_init();
...
![Adafruit IO](/iot-adafruit-io.png)
...
![SD Card Interface](/iot-sd-card.png)
CSV Format:
...
![Adafruit IO MQTT Feed Format](/iot-adafruit-mqtt.png)
...
![Capacitive vs Resistive Sensors](/iot-cap-res.png)
Calibration Process:
...
![Closed-Loop Control](/iot-closed-loop.png)
Safety Features:
...
![Relay Activation](/iot-relay-activation.png)
...
![MQTT-Based Alert Flow](/iot-mqtt-flow.png)
