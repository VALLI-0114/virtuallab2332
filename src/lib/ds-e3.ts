  ...
  experiments: [
    {
      ...
      content: {
        ...
        posttest: [
          { question: "After removing duplicates from 5 -> 3 -> 5 -> 2 -> 3 -> NULL what is the resulting list?", options: ["5 -> 3 -> 2 -> NULL", "3 -> 5 -> 2 -> NULL", "5 -> 2 -> 3 -> NULL", "2 -> 3 -> 5 -> NULL"], answerIndex: 0 },
          { question: "What is the time complexity of the two-pointer duplicate removal on a list of n nodes?", options: ["O(n)", "O(n log n)", "O(n²)", "O(1)"], answerIndex: 2 },
          { question: "For the list 7 -> 7 -> 7 -> 7 -> NULL how many free() calls are made during duplicate removal?", options: ["1", "2", "3", "4"], answerIndex: 2 },
          { question: "The two-pointer approach preserves which occurrence of each duplicate value?", options: ["The last occurrence", "The middle occurrence", "The first occurrence", "The occurrence with the smallest memory address"], answerIndex: 2 },
          { question: "A student uses the hashing approach for duplicate removal instead of two-pointer. The list has n nodes with k unique values. What is the space used by the hash set?", options: ["O(n)", "O(k) where k is the number of unique values — O(n) in the worst case", "O(1)", "O(n²)"], answerIndex: 1 }
        ],
        references: [
    ...
    },
    {
      ...
      content: {
        ...
        pretest: [
          { question: "In the linked list representation of a polynomial what does each node store?", options: ["Only the coefficient of the term", "Only the exponent of the term", "Both the coefficient and exponent of one term plus a pointer to the next term", "The entire polynomial expression as a string"], answerIndex: 2 },
          { question: "In what order are polynomial terms stored in the linked list for easy addition?", options: ["Ascending order of coefficients", "Descending order of exponents", "Ascending order of exponents", "Random order determined by input"], answerIndex: 1 },
          { question: "When adding two polynomial terms with the same exponent what is stored in the result node?", options: ["The larger of the two coefficients", "The product of the two coefficients", "The sum of the two coefficients with the same exponent", "Two separate nodes one for each coefficient"], answerIndex: 2 },
          { question: "What is the time complexity of polynomial addition using two sorted linked lists of m and n terms respectively?", options: ["O(m × n)", "O(m + n)", "O(m² + n²)", "O(log(m + n))"], answerIndex: 1 },
          { question: "What should happen when two terms with equal exponents have coefficients that sum to zero?", options: ["A node with coefficient 0 should be added to the result", "The node should not be added to the result — zero coefficient terms are omitted", "The program should terminate", "Both original nodes should be kept in the result"], answerIndex: 1 }
        ],
        procedure: [
        ...
        posttest: [
          { question: "P1 = 4x³ + 2x and P2 = 3x³ + 5x² + x. What is the result of P1 + P2?", options: ["7x³ + 5x² + 3x", "7x³ + 5x² + 2x", "4x³ + 5x² + 3x", "7x⁶ + 5x² + 3x"], answerIndex: 0 },
          { question: "P1 = 3x² + 2x and P2 = −3x² + 5. What happens to the x² term in the result?", options: ["It becomes 6x²", "It becomes 0x² and is included in result", "It becomes 0x² and is omitted from result since zero coefficient terms are dropped", "It causes an error in the program"], answerIndex: 2 },
